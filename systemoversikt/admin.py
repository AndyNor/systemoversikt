...
class ProfileAdmin(admin.ModelAdmin):
	list_display = ('user', 'virksomhet', 'org_unit', 'usertype', 'from_prk', 'service_principal_name', 'adgrupper_antall', 'description')
	...
	list_filter = ('usertype', 'trusted_for_delegation', 'from_prk', 'whenCreated')
