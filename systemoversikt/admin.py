...
class CMDBdeviceAdmin(admin.ModelAdmin):
	actions = [export_as_csv_action("CSV Eksport")]
	list_display = ('comp_name', 'device_type', 'model_id', 'sist_sett', 'last_loggedin_user', 'device_active', 'kilde_cmdb', 'kilde_prk', 'kilde_landesk', 'maskinadm_status', 'maskinadm_virksomhet_str', 'sub_name', 'comp_ip_address', 'comp_os_readable', 'comp_ram', 'dns', 'vlan')
