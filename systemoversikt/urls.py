...
urlpatterns = [
	...
	re_path(r'^rapport/system_per_isk/$', views.isk_ansvarlig_for_system, name='isk_ansvarlig_for_system'),
	re_path(r'^rapport/system_kit_vurderinger/$', views.rapport_kit_vurderinger_samlet, name='rapport_kit_vurderinger_samlet'),
