...
urlpatterns = [
	...
	url(r'^virksomhet/kontaktinfo/$', views.alle_virksomheter_kontaktinfo, name='alle_virksomheter_kontaktinfo'),
	...
	url(r'^cmdb/servere/alle/$', views.alle_maskiner, name='alle_maskiner'),
	...
	url(r'^virksomhet/drift/prioriteringer/(?P<pk>\d{1,8})/(?P<eier>\d{1,8})$', views.drift_beredskap, name='drift_beredskap_for_eier'),
