...
if THIS_ENVIRONMENT == "PROD":
	hosts = ["kartoteket.oslo.kommune.no", "systemoversikt.oslo.kommune.no", "okkartoteket-oslokommune.msappproxy.net", "kartoteket.sc2test.oslo.kommune.no", "10.218.240.59"]
