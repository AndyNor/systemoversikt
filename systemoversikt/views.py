...
def all_bruk_for_virksomhet(request, pk):
	...
	virksomhet_pk = pk
	all_bruk = SystemBruk.objects.filter(brukergruppe=virksomhet_pk).exclude(livslop_status__in=[6,7]).order_by(Lower('system__systemnavn'))  # sortering er ellers case-sensitiv
