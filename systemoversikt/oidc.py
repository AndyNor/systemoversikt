...
class CustomOIDCAuthenticationBackend(OIDCAuthenticationBackend):
	...
	def update_user(self, user, claims):
		...
		user.save()
		messages.success(self.request, 'Du er nå logget på. Trykk på navnet ditt for å få opp mer administrativ informasjon. Ved siden av navnet ditt står det også hvilken virksomhet du nå representerer. Dette kan endre med "bytt"-knappen.')
		return user
